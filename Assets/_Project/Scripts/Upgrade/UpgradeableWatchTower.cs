...
{
    public class UpgradeableWatchTower : Upgradeable
    {
        ...
        private void SetValues()
        {
            ...
            if (allLevelsData.allUpgrades.Count-1 > allLevelsData.CurrentLevel)
            {
                ...
                upgradeManagerSo.upgradeInfo = "This will fire " + allLevelsData.allUpgrades[allLevelsData.CurrentLevel+1].maxCapacity + " arrow per second";
            }
        }
